        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"> this Products  Add By {{$user->name}} </h3>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                @foreach($all_product_user as $product)
                @if($product->trashed())
                ...
                @endif
                  ...
                  <td>{{$product->id}}</td>
                  <td><a href="{{url('/admin-cp/all-product/user/'.$product->useres->id)}}"> {{ucfirst($product->useres->name)}} </a></td>
